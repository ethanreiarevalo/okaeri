            ...
            <div class="jumbotron bg-transparent">
                ...
                <div class="row justify-content-center">
                    <form class="col-xl-4 m-1" action="">
                        <input type="text" id="voucher_name" class="form-control text-center" name="voucher_name" placeholder="Enter Voucher Name">
                        <input type="text" id="voucher_amount" class="form-control text-center" name="voucher_amount" placeholder="Enter Amount of voucher">
