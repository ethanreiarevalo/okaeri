...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2019 at 04:51 AM
...
(0, 1, '2019-11-23', 13, 'Cash On Delivery', 'Delivered'),
(4, 2, '2019-11-23', 13, 'Cash On Delivery', 'Delivered'),
...
(0, 1, '2019-11-24', 15, '', 'Undelivered'),
(1, 2, '2019-11-24', 15, '', 'Cancelled'),
(0, 1, '2019-11-24', 16, 'Cash On Delivery', 'Undelivered'),
(3, 5, '2019-11-24', 16, 'Cash On Delivery', 'Cancelled'),
(0, 1, '2019-11-24', 17, 'Cash On Delivery', 'Undelivered'),
(0, 1, '2019-11-24', 18, 'Cash On Delivery', 'Undelivered'),
(0, 1, '2019-11-24', 18, 'Cash On Delivery', 'Undelivered'),
(0, 1, '2019-11-24', 18, 'Cash On Delivery', 'Undelivered'),
(0, 1, '2019-11-24', 18, 'Cash On Delivery', 'Undelivered'),
(0, 1, '2019-11-24', 22, 'Cash On Delivery', 'Undelivered'),
(1, 3, '2019-11-24', 22, 'Cash On Delivery', 'Undelivered'),
(0, 1, '2019-11-24', 18, 'Cash On Delivery', 'Undelivered');
...
(1, 'Kono Subarashii Sekai ni Shukufuku wo! Volume 10', 'Natsume Akatsuki', 'Yen Press', 'Light Novel', 'Japanese', '2019-11-07', '2016-11-01', 'fantasy, action', 'product_image/v10cover.jpg', 45, 300.00, 'After Belzerg\'s financial support is cut off, Iris is forced into an arranged marriage with Elroad\'s crown prince in an attempt to regain the funding Belzerg so desperately needs to continue repelling the Demon King\'s invasion. With even this maneuver not guaranteed to succeed, Iris calls for help from the one person which common sense never seems to apply to.'),
...
(12, 200, '2019-11-23', 10, 'Cash On Delivery', 'Delivered'),
(13, 290, '2019-11-23', 10, 'Cash On Delivery', 'Delivered'),
(14, 0, '2019-11-23', 10, 'Cash On Delivery', 'Undelivered'),
(15, -550, '2019-11-24', 10, '', 'Undelivered'),
(16, 0, '2019-11-24', 10, 'Cash On Delivery', 'Cancelled'),
(17, 770, '2019-11-24', 10, 'Cash On Delivery', 'Undelivered'),
(18, 650, '2019-11-24', 10, 'Cash On Delivery', 'Undelivered'),
(19, 650, '2019-11-24', 10, 'Cash On Delivery', 'Undelivered'),
(20, 650, '2019-11-24', 10, 'Cash On Delivery', 'Undelivered'),
(21, 650, '2019-11-24', 10, 'Cash On Delivery', 'Undelivered'),
(22, 1550, '2019-11-24', 10, 'Cash On Delivery', 'Undelivered'),
(23, 650, '2019-11-24', 10, 'Cash On Delivery', 'Undelivered');
...
INSERT INTO `vouchers` (`voucherID`, `voucherName`, `voucherAmount`, `voucherDiscount`) VALUES
(3922, 'sample voucher', 10, 0.00);
...
--
ALTER TABLE `sales`
  MODIFY `salesID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
