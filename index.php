        ...
        <div class="container mt-3 position-relative">
            ...
            <div id="card" class="">
                <div class="row justify-content-center">
                    ...
                    $getItems = "SELECT * FROM products WHERE productType = 'Light Novel' order by productDateReceived desc limit 5";
        ...
        <div class="container mt-3 position-relative">
            ...
            <div id="card" class="">
                <div class="row justify-content-center">
                    <?php
                    include('connection.php');
                    $getItems = "SELECT * FROM products Where productType = 'Manga' order by productDateReceived desc limit 5";
                    $result = mysqli_query($connection, $getItems);
                    if(mysqli_num_rows($result) > 0){
                        while($row = mysqli_fetch_array($result)){                    ?>
                    <div class="card col-lg-2 col-md-3 col-5 m-2 px-0 shadow border border-warning">
